...
public class StandardParts : Entity, IAggregateRoot
{
    ...
    public StandardParts(string title, string code, UnitOfMeasureEnum unitOfMeasure, string? technicalSpecifications, string? createdBy = null)
    {
        if (!title.HasValue())
